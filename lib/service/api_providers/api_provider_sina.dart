...
class ApiProviderSina extends ApiProvider {
  ...
  Future<dynamic> fetchQuote() async {
    try {
      ...
      final results = await Future.wait([
        _fetchMarketShares('sh_a', 1, 3000), // 沪市A股
        _fetchMarketShares('sz_a', 1, 3000), // 深市A股
        _fetchMarketShares('', 0, 1000), // 创业板
      ]);
  ...
  // 获取和讯网股票列表数据
  Future<dynamic> _fetchMarketShares(String market, int pageOffset, int pageSize) async {
