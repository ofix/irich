// ///////////////////////////////////////////////////////////////////////////
// Name:        irich/lib/components/rich_widget/rich_widget_market_list.dart
// Purpose:     market list rich widget
// Author:      songhuabiao
...
import 'package:irich/store/rich_widgets/rich_widget_provider_market_list.dart';

// 市场行情列表控件
class RichWidgetMarketList extends RichWidget {
  const RichWidgetMarketList({super.key, required super.panelId, super.groupId = 0});
  @override
  ConsumerState<RichWidgetMarketList> createState() => _RichWidgetMarketListState();
}

class _RichWidgetMarketListState extends ConsumerState<RichWidgetMarketList>
  ...
  void initState() {
    ...
    shareList = ref.read(
      richWidgetMarketListProviders(
        RichWidgetMarketListParams(panelId: widget.panelId, groupId: widget.groupId),
      ),
    );
