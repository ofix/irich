// ///////////////////////////////////////////////////////////////////////////
// Name:        irich/lib/components/rich_widgets/rich_widget_industry_list.dart
// Purpose:     industry list rich widget
// Author:      songhuabiao
...
// 股票概念列表
class RichWidgetIndustryList extends RichWidget {
  const RichWidgetIndustryList({super.key, required super.panelId, super.groupId = 0});
  @override
  ConsumerState<RichWidgetIndustryList> createState() => _RichWidgetIndustryListState();
}

class _RichWidgetIndustryListState extends ConsumerState<RichWidgetIndustryList>
  ...
  late List<ShareIndustry> industryList;
  ...
  void initState() {
    ...
    for (int i = 0; i < industryList.length; i++) {
      posHash[industryList[i].name] = i;
    }
    // 读取当前设置的股票代码
    String industryName = industryList.first.name;
    // 获取当前股票位置序号
